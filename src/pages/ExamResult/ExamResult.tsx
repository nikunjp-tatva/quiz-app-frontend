        ...
        <Box sx={{ p: 4 }}>
            <Card sx={{ minHeight: '40vh' }}>
                <CardContent>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                        <Box sx={{ justifyContent: 'flex-start' }} p={4}>
                            ...
                            {result?.status && (
                                <Typography variant='body1' pt={1}>
                                    {` Status: `}
                                    <Typography variant='body1' fontWeight={600} display='inline-block' sx={{ color: result?.status === 'pass' ? 'green' : 'red' }}>
                    ...
                    <Typography variant='h5' textAlign='center' sx={{ color: '#454545' }} pt={1}>
                        {result?.skippedQuestions?.length > 0 ? 'Skipped Questions' : 'No Skipped Questions Available'}
                    </Typography>

                    {result?.skippedQuestions?.length > 0 && <SkippedQuestions questions={result?.skippedQuestions} />}
